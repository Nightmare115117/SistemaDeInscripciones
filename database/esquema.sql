...
\restrict F9sPcRMLpeLsWipP0CiSpwQiG9IxhGiJwumWQY42nUnChLcHmnoNk8vzsf00ZpL
...
--
-- Name: normalizar_ids_opcionales(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.normalizar_ids_opcionales() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
CREATE TABLE public.admin (
    ...
    correo_aes character varying NOT NULL,
    contrasena character varying NOT NULL,
    correo_hmac character varying NOT NULL
);


--
-- Name: Admin_adminId_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.admin ALTER COLUMN adminid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Admin_adminId_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.alumnos (
    ...
    idequipo bigint DEFAULT '-1'::bigint NOT NULL,
    firmoterminos boolean DEFAULT false NOT NULL,
    correo character varying DEFAULT ''::character varying NOT NULL,
    numerotel character varying DEFAULT ''::character varying NOT NULL,
    apellidopaterno character varying DEFAULT ''::character varying NOT NULL,
    apellidomaterno character varying DEFAULT ''::character varying NOT NULL,
    alergias character varying DEFAULT ''::character varying NOT NULL,
    condicion character varying DEFAULT ''::character varying NOT NULL,
    medicamento character varying DEFAULT ''::character varying NOT NULL,
    idcontacto bigint DEFAULT '-1'::bigint NOT NULL,
    iduniversidad bigint NOT NULL,
    institucion character varying(200) DEFAULT ''::character varying NOT NULL
);


--
-- Name: TABLE alumnos; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.alumnos IS 'Aqui van alumnso';


--
-- Name: Alumnos_IdAlumno_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.alumnos ALTER COLUMN idalumno ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Alumnos_IdAlumno_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: contactoemergencia; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.contactoemergencia (
    idcontacto bigint NOT NULL,
    nombre character varying NOT NULL,
    telefono character varying,
    pariente character varying
);


--
-- Name: ContactoEmergencia_IdContacto_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.contactoemergencia ALTER COLUMN idcontacto ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."ContactoEmergencia_IdContacto_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.equipo (
    ...
    nombre_equipo character varying DEFAULT ''::character varying NOT NULL,
    idlider bigint NOT NULL,
    idproblematica bigint,
...
COMMENT ON TABLE public.equipo IS 'Aqui van los equipos';


--
-- Name: Equipo_idEquipos_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.equipo ALTER COLUMN idequipo ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Equipo_idEquipos_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: problematica; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.problematica (
...
--
-- Name: Problematica_IdProblematica_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.problematica ALTER COLUMN idproblematica ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Problematica_IdProblematica_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: TABLE registro; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.registro IS 'Fecha y hora de Registro';


--
-- Name: Registro_idRegistro_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.registro ALTER COLUMN idregistro ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Registro_idRegistro_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.universidades (
    iduniversidad bigint NOT NULL,
    nombre_uni character varying DEFAULT ''::character varying NOT NULL
);


--
-- Name: TABLE universidades; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.universidades IS 'Aqui van las universidades';


--
-- Name: Universidades_idUniversidad_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.universidades ALTER COLUMN iduniversidad ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."Universidades_idUniversidad_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.agenda (
    id text DEFAULT ('ev-'::text || (gen_random_uuid())::text) NOT NULL,
    dia character varying(20) NOT NULL,
    inicio time without time zone NOT NULL,
    fin time without time zone NOT NULL,
    titulo character varying(200) NOT NULL,
    detalle text,
    tipo character varying(40) DEFAULT 'service'::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: agenda_responsable; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agenda_responsable (
...
--
-- Name: correo_configuracion; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.correo_configuracion (
    id smallint DEFAULT 1 NOT NULL,
    configurado boolean DEFAULT false NOT NULL,
    habilitado boolean DEFAULT false NOT NULL,
    remitente character varying(320) DEFAULT ''::character varying NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT correo_configuracion_id_check CHECK ((id = 1))
);


--
-- Name: evento_configuracion; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.evento_configuracion (
    id smallint DEFAULT 1 NOT NULL,
    cupo integer DEFAULT 60 NOT NULL,
    min_integrantes smallint DEFAULT 3 NOT NULL,
    max_integrantes smallint DEFAULT 5 NOT NULL,
    registro_abierto boolean DEFAULT true NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT evento_configuracion_check CHECK ((max_integrantes >= min_integrantes)),
    CONSTRAINT evento_configuracion_cupo_check CHECK ((cupo > 0)),
    CONSTRAINT evento_configuracion_id_check CHECK ((id = 1)),
    CONSTRAINT evento_configuracion_min_integrantes_check CHECK ((min_integrantes > 0))
);


--
-- Name: patrocinadores; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.patrocinadores (
    id text DEFAULT ('sp-'::text || (gen_random_uuid())::text) NOT NULL,
    nombre character varying(180) NOT NULL,
    logo text DEFAULT ''::text NOT NULL,
    url text DEFAULT ''::text NOT NULL,
    nivel character varying(30) DEFAULT 'aliado'::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT patrocinadores_nivel_ck CHECK (((nivel)::text = ANY ((ARRAY['principal'::character varying, 'aliado'::character varying])::text[])))
);
...
CREATE TABLE public.staff (
    id text DEFAULT ('staff-'::text || (gen_random_uuid())::text) NOT NULL,
    ...
    telefono character varying(40) DEFAULT ''::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: admin Admin_Correo_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.admin
    ADD CONSTRAINT "Admin_Correo_key" UNIQUE (correo_aes);
...
--
-- Name: contactoemergencia ContactoEmergencia_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contactoemergencia
    ADD CONSTRAINT "ContactoEmergencia_pkey" PRIMARY KEY (idcontacto);
...
--
-- Name: problematica Problematica_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.problematica
    ADD CONSTRAINT "Problematica_pkey" PRIMARY KEY (idproblematica);
...
--
-- Name: admin admin_correo_hmac_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.admin
    ADD CONSTRAINT admin_correo_hmac_key UNIQUE (correo_hmac);
...
--
-- Name: agenda_responsable agenda_responsable_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agenda_responsable
    ADD CONSTRAINT agenda_responsable_pkey PRIMARY KEY (agenda_id, staff_id);


--
-- Name: alumnos alumnos_correo_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: alumnos alumnos_numerotel_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumnos_numerotel_key UNIQUE (numerotel);


--
-- Name: correo_configuracion correo_configuracion_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.correo_configuracion
    ADD CONSTRAINT correo_configuracion_pkey PRIMARY KEY (id);


--
-- Name: evento_configuracion evento_configuracion_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.evento_configuracion
    ADD CONSTRAINT evento_configuracion_pkey PRIMARY KEY (id);


--
-- Name: patrocinadores patrocinadores_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_correo_hmac_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX admin_correo_hmac_uidx ON public.admin USING btree (correo_hmac);


--
-- Name: agenda_dia_inicio_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX agenda_dia_inicio_idx ON public.agenda USING btree (dia, inicio);


--
-- Name: alumnos_correo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX alumnos_correo_idx ON public.alumnos USING btree (correo);


--
-- Name: alumnos_idequipo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX alumnos_idequipo_idx ON public.alumnos USING btree (idequipo);


--
-- Name: equipo_estado_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX equipo_estado_idx ON public.equipo USING btree (estado);


--
-- Name: problematica_codigo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX problematica_codigo_idx ON public.problematica USING btree (codigo);


--
-- Name: problematica_codigo_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX problematica_codigo_uidx ON public.problematica USING btree (codigo) WHERE (codigo IS NOT NULL);


--
-- Name: registro_idequipo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX registro_idequipo_idx ON public.registro USING btree (idequipo);
...
--
-- Name: alumnos alumno_normalizar_ids; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER alumno_normalizar_ids BEFORE INSERT OR UPDATE ON public.alumnos FOR EACH ROW EXECUTE FUNCTION public.normalizar_ids_opcionales();


--
-- Name: equipo equipo_normalizar_ids; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER equipo_normalizar_ids BEFORE INSERT OR UPDATE ON public.equipo FOR EACH ROW EXECUTE FUNCTION public.normalizar_ids_opcionales();
...
--
-- Name: alumnos Alumnos_IdContacto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT "Alumnos_IdContacto_fkey" FOREIGN KEY (idcontacto) REFERENCES public.contactoemergencia(idcontacto);


--
-- Name: alumnos Alumnos_IdEquipo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT "Alumnos_IdEquipo_fkey" FOREIGN KEY (idequipo) REFERENCES public.equipo(idequipo);


--
-- Name: equipo Equipo_IdLider_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equipo
    ADD CONSTRAINT "Equipo_IdLider_fkey" FOREIGN KEY (idlider) REFERENCES public.alumnos(idalumno);


--
-- Name: equipo Equipo_IdProblematica_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equipo
    ADD CONSTRAINT "Equipo_IdProblematica_fkey" FOREIGN KEY (idproblematica) REFERENCES public.problematica(idproblematica);


--
-- Name: registro Registro_IdEquipo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT "Registro_IdEquipo_fkey" FOREIGN KEY (idequipo) REFERENCES public.equipo(idequipo);


--
-- Name: agenda_responsable agenda_responsable_agenda_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agenda_responsable
    ADD CONSTRAINT agenda_responsable_agenda_id_fkey FOREIGN KEY (agenda_id) REFERENCES public.agenda(id) ON DELETE CASCADE;


--
-- Name: agenda_responsable agenda_responsable_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agenda_responsable
    ADD CONSTRAINT agenda_responsable_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id) ON DELETE CASCADE;


--
-- Name: alumnos alumno_contacto_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumno_contacto_fk FOREIGN KEY (idcontacto) REFERENCES public.contactoemergencia(idcontacto) ON DELETE SET NULL;


--
-- Name: alumnos alumno_equipo_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumno_equipo_fk FOREIGN KEY (idequipo) REFERENCES public.equipo(idequipo) ON DELETE CASCADE;


--
-- Name: alumnos alumno_universidad_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumno_universidad_fk FOREIGN KEY (iduniversidad) REFERENCES public.universidades(iduniversidad) ON DELETE SET NULL;


--
-- Name: alumnos alumnos_iduniversidad_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.alumnos
    ADD CONSTRAINT alumnos_iduniversidad_fkey FOREIGN KEY (iduniversidad) REFERENCES public.universidades(iduniversidad);


--
-- Name: equipo equipo_problematica_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equipo
    ADD CONSTRAINT equipo_problematica_fk FOREIGN KEY (idproblematica) REFERENCES public.problematica(idproblematica);


--
-- Name: equipo equipo_universidad_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.equipo
    ADD CONSTRAINT equipo_universidad_fk FOREIGN KEY (iduniversidad) REFERENCES public.universidades(iduniversidad);


--
-- Name: registro registro_equipo_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT registro_equipo_fk FOREIGN KEY (idequipo) REFERENCES public.equipo(idequipo) ON DELETE CASCADE;
...
--
-- Name: agenda; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.agenda ENABLE ROW LEVEL SECURITY;

--
-- Name: agenda_responsable; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.agenda_responsable ENABLE ROW LEVEL SECURITY;
...
--
-- Name: contactoemergencia; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.contactoemergencia ENABLE ROW LEVEL SECURITY;

--
-- Name: correo_configuracion; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.correo_configuracion ENABLE ROW LEVEL SECURITY;
...
--
-- Name: evento_configuracion; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.evento_configuracion ENABLE ROW LEVEL SECURITY;

--
-- Name: patrocinadores; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.patrocinadores ENABLE ROW LEVEL SECURITY;

--
-- Name: problematica; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.problematica ENABLE ROW LEVEL SECURITY;

--
-- Name: registro; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: universidades; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION normalizar_ids_opcionales(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.normalizar_ids_opcionales() TO anon;
GRANT ALL ON FUNCTION public.normalizar_ids_opcionales() TO authenticated;
GRANT ALL ON FUNCTION public.normalizar_ids_opcionales() TO service_role;
...
--
-- Name: SEQUENCE "Admin_adminId_seq"; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE "Alumnos_IdAlumno_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."Alumnos_IdAlumno_seq" TO service_role;


--
-- Name: TABLE contactoemergencia; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.contactoemergencia TO service_role;


--
-- Name: SEQUENCE "ContactoEmergencia_IdContacto_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."ContactoEmergencia_IdContacto_seq" TO service_role;


--
-- Name: TABLE equipo; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE "Equipo_idEquipos_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."Equipo_idEquipos_seq" TO service_role;


--
-- Name: TABLE problematica; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.problematica TO service_role;


--
-- Name: SEQUENCE "Problematica_IdProblematica_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."Problematica_IdProblematica_seq" TO service_role;


--
-- Name: TABLE registro; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.registro TO service_role;


--
-- Name: SEQUENCE "Registro_idRegistro_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."Registro_idRegistro_seq" TO service_role;


--
-- Name: TABLE universidades; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.universidades TO service_role;


--
-- Name: SEQUENCE "Universidades_idUniversidad_seq"; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public."Universidades_idUniversidad_seq" TO service_role;


--
-- Name: TABLE agenda; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agenda_responsable; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.agenda_responsable TO service_role;


--
-- Name: TABLE correo_configuracion; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.correo_configuracion TO service_role;


--
-- Name: TABLE evento_configuracion; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.evento_configuracion TO service_role;


--
-- Name: TABLE patrocinadores; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE rol_id_rol_seq; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict F9sPcRMLpeLsWipP0CiSpwQiG9IxhGiJwumWQY42nUnChLcHmnoNk8vzsf00ZpL
